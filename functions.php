...
function portfolio_styles() {
	...
	wp_enqueue_style( 'main-styles', get_template_directory_uri() . '/css/main.css', array(), time() );
	wp_enqueue_style( 'fonts-awesome', "https://use.fontawesome.com/releases/v5.2.0/css/all.css?ver=5.3.2");
}
add_action( 'wp_enqueue_scripts', 'portfolio_styles' );

function portfolio_scripts() {
	wp_enqueue_script( 'main-scripts', get_template_directory_uri() . '/js/main.js', array(), time(), true);
...
require get_template_directory() . '/inc/nav-walker-menu.php';
...
function my_navigation_template( $template, $class ){
	return '<nav class="pagination-container %1$s" role="navigation" aria-label="Page navigation">%3$s</nav>    ';
}

/* убираем слово "Рубрика" из категорий */
